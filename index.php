...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Discover the expertise of Avinash Tare, a proficient freelance Full Stack Web Developer. Specializing in front-end and back-end technologies, Avinash delivers innovative web solutions tailored to your needs. Connect for responsive web development, custom applications, and seamless user experiences. Hire a skilled web developer today for your digital success."
    />
    <meta
      name="keywords"
      content="Avinash Tare,Avinash,Tare Avinash,Web Design,Freelance"
    />
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    >
      <div class="container">
        <a class="navbar-brand" href="index.html">Avinash</a>
        <button
            ...
            >
              ...
              >
                <div class="text">
                  ...
                  <h1 class="mb-4 mt-3">I'm <span>Avinash Tare</span></h1>
                  <h2 class="mb-4">A Freelance Full Stack Developter</h2>
                  <p>
            ...
            >
              ...
              >
                <div class="text">
                  <span class="subheading">Hello!</span>
                  <h1 class="mb-4 mt-3">
                    I'm a <span>Full Stack Web Developer</span> based in Mumbai
                  </h1>
                  <p>
                    <a href="#" class="btn btn-primary py-3 px-4">Hire me</a>
                    <a
            ...
            <div class="row justify-content-start pb-3">
              <div class="col-md-12 heading-section ftco-animate">
                ...
                <ul class="about-info mt-4 px-md-0 px-2">
                  <li class="d-flex">
                    <span>Name:</span> <span>Avinash Tare</span>
                  </li>
                  <li class="d-flex">
                    <span>Date of birth:</span> <span>February 02, 2006</span>
                  </li>
                  <li class="d-flex">
                    <span>Address:</span> <span>Mumbai MH 421004 INDIA</span>
                  </li>
                  <li class="d-flex">
                    <span>Zip code:</span> <span>421004</span>
                  </li>
                  <li class="d-flex">
                    <span>Email:</span> <span>avinashtare.work@gmail.com</span>
                  </li>
                  <li class="d-flex">
                    <span>Phone: </span> <span>+91-111-222-333-0</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="resume-wrap ftco-animate">
              ...
              <span class="position">My University</span>
              <p class="mt-4">
                A small river named Duden flows by their place and supplies it
                with the necessary regelialia. It is a paradisematic country, in
                which roasted parts of sentences fly into your mouth.
        ...
        <div class="row d-flex contact-info mb-5">
          ...
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
            <div class="align-self-stretch box p-4 text-center">
              ...
              <p><a href="mailto:avinashtare.work@gmail.com">avinashtare.work@gmail.com</a></p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
            <div class="align-self-stretch box p-4 text-center">
              ...
              <p><a href="#">avinashtare.online</a></p>
            </div>
          </div>
        </div>
